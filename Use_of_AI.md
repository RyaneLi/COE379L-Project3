...
[1]. Tool: ChatGPT (via Cursor AI)
     ...
     Output:
       - Notebook structure with imports (pandas, numpy, matplotlib, seaborn, datasets)
       - Function to load AG News dataset from Hugging Face
       - Basic EDA functions for dataset exploration
